        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                	...
                	<form method="POST" action="t_keluarga.php">
					  <div class="form-group row">
					    <label for="NO_KK" class="col-sm-2 col-form-label">NO KK</label>
					    <div class="col-sm-10">
					      <input type="text" class="form-control" id="NO_KK" name="NO_KK" placeholder="NO_KK" required>
					    </div>
					  </div>
					  ...
					  <div class="form-group row">
					    ...
					    <div class="col-sm-10">
					      <input type="number" class="form-control" id="PENGHASILAN" name="PENGHASILAN" placeholder="PENGHASILAN" required="required">
					    </div>
					  </div>
