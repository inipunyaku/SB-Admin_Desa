        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form method="POST" action="t_anggota.php?id=<?php echo $id; ?>">
                    
                      <div class="form-group row">
                        <label for="ID_PENDUDUK" class="col-sm-2 col-form-label">NIK & Nama</label>
                        <div class="col-sm-10">
                          <select class="form-control form-control-lg" id="ID_PENDUDUK" name="ID_PENDUDUK" required>
                            <option>--NIK - NAMA--</option>
                            <?php 
                                while ($d = mysqli_fetch_array($data)) {
                             ?>
                            <option value="<?php echo $d['ID_PENDUDUK'];?>"><?php echo $d['NIK']; ?> - <?php echo $d['NAMA']; ?></option>
                            <?php } ?>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <select class="form-control form-control-lg" id="HUBUNGAN_KELUARGA" name="HUBUNGAN_KELUARGA" required>
                            <option>--NIK - NAMA--</option>
