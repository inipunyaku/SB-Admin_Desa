        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                	<h1 class="h3 mb-2 text-gray-800">Form Tambah Perangkat Desa</h1>

                	<form method="POST" action="t_pd.php">
					  <div class="form-group row">
					    <label for="NAMA_PERANGKAT_DESA" class="col-sm-2 col-form-label">NAMA</label>
					    <div class="col-sm-10">
					      <input type="text" class="form-control" id="NAMA_PERANGKAT_DESA" name="NAMA_PERANGKAT_DESA" placeholder="NAMA_PERANGKAT_DESA" required>
					    </div>
					  </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-check form-check-inline">
                              <input class="form-check-input" type="radio" name="JENIS_KELAMIN" id="laki-Laki" value="Laki-Laki" required="required">
                              <label class="form-check-label" for="inlineRadio1">LAKI-LAKI</label>
                            </div>
                            <div class="form-check form-check-inline">
                              <input class="form-check-input" type="radio" name="JENIS_KELAMIN" id="perempuan" value="perempuan" required="required">
