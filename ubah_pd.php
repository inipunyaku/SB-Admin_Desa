        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <?php 
                    include 'koneksi.php';
                    $id = $_GET['id'];
                    $data = mysqli_query($koneksi, "SELECT * FROM perangkat_desa WHERE ID_PERANGKAT_DESA = '$id'");
                ...
                <div class="container-fluid">
                	<h1 class="h3 mb-2 text-gray-800">Form edit Perangkat Desa</h1>

                	<form method="POST" action="u_pd.php?id=<?php echo $id; ?>">
					  <div class="form-group row">
					    <label for="NAMA_PERANGKAT_DESA" class="col-sm-2 col-form-label">NAMA</label>
					    <div class="col-sm-10">
					      <input type="text" class="form-control" id="NAMA_PERANGKAT_DESA" name="NAMA_PERANGKAT_DESA" placeholder="NAMA_PERANGKAT_DESA" value="<?php echo $d['NAMA_PERANGKAT_DESA']; ?>"  required>
					    </div>
					  </div>
					  ...
					  <div class="form-group row">
					    ...
					    <div class="col-sm-10">
					      <input type="date" class="form-control" id="TANGGAL_LAHIR" name="TANGGAL_LAHIR" value="<?php echo $d['TANGGAL_LAHIR']; ?>"  required="required">
					    </div>
					  </div>
					  ...
					  <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <textarea type="text" class="form-control" id="ALAMAT" name="ALAMAT" placeholder="ALAMAT"><?php echo $d['ALAMAT']; ?></textarea> 
                        </div>
                      </div>
