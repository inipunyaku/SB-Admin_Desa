            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                 <?php 
                    include 'koneksi.php';
                    $id = $_GET['id'];
                    $data = mysqli_query($koneksi, "SELECT * FROM keluarga WHERE ID_KELUARGA = '$id'");
                    $d = mysqli_fetch_array($data);
                ?>

                <div class="container-fluid">
                	<h1 class="h3 mb-2 text-gray-800">Form Ubah Keluarga</h1>

                	<form method="POST" action="u_keluarga.php?id=<?php echo $id; ?>">
					  <div class="form-group row">
					    <label for="NO_KK" class="col-sm-2 col-form-label">NO KK</label>
					    <div class="col-sm-10">
					      <input type="text" class="form-control" id="NO_KK" name="NO_KK" placeholder="NO_KK" value="<?php echo $d['NO_KK']; ?>" required>
					    </div>
					  </div>
					  ...
					  <div class="form-group row">
					    ...
					    <div class="col-sm-10">
					      <input type="number" class="form-control" id="PENGHASILAN" name="PENGHASILAN" placeholder="PENGHASILAN" value="<?php echo $d['PENGHASILAN']; ?>" required="required">
					    </div>
					  </div>
